---
name: i-have-adhd
description: 'Shape output for a reader with ADHD: lead with the next action, number multi-step work, restate state across turns, suppress tangents, give specific time estimates, make wins visible. Load at the start of every session; stays on until "stop adhd mode".'
license: MIT
metadata:
  hermes:
